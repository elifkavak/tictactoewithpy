...
# loading the images
path_to_opening = os.path.abspath(os.path.join(bundle_dir, "ım.png"))
opening = pg.image.load(path_to_opening)
path_to_x = os.path.abspath(os.path.join(bundle_dir2, "x-sy.png"))
x_img = pg.image.load(path_to_x)
path_to_o = os.path.abspath(os.path.join(bundle_dir3, "o-sy.png"))
